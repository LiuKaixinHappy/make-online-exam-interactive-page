 ...
 * @returns {HTMLElement}
 */
function add_blank_div(questions) {
 ...
 */
function add_single_choice_div(questions) {
 ...
 * @returns {HTMLDivElement}
 */
function add_multi_choices_div(questions) {
 ...
 * @returns {HTMLDivElement}
 */
function add_judge_div(questions) {
 ...
 * @returns {HTMLDivElement}
 */
function add_short_answer_div(questions) {
...
document.getElementById('content').appendChild(add_blank_div(get_blank_questions()));
document.getElementById('content').appendChild(add_single_choice_div(get_single_choice_questions()));
document.getElementById('content').appendChild(add_multi_choices_div(get_multi_choices_questions()));
document.getElementById('content').appendChild(add_judge_div(get_judge_questions()));
document.getElementById('content').appendChild(add_short_answer_div(get_short_answer_questions()));
